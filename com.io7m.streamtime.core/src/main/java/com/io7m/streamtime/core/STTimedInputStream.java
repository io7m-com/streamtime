...
package com.io7m.streamtime.core;

import com.io7m.streamtime.core.internal.STStatisticsTracker;
...
public final class STTimedInputStream extends ProxyInputStream
{
  ...
  {
    this(OptionalLong.empty(), statsConsumer, inStream);
  }
    ...
    final InputStream inStream)
  {
    ...
    this.tracker = new STStatisticsTracker(expected, statsConsumer);
  }
